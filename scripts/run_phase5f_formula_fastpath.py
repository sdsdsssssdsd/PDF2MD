...
"""Phase 5F：Formula Fast Path 消融 + O-018×10 稳定性。
  ...
  python -u scripts/run_phase5f_formula_fastpath.py
  python -u scripts/run_phase5f_formula_fastpath.py --runs 10
  python -u scripts/run_phase5f_formula_fastpath.py --ablate-only
"""
